...
if __name__ == "__main__":
    ...
    imgpath = r'D:/ultralytics-main/zhongyaodata/zhongyaodataset/data_batch3/image_jpg'       # 设置图像文件路径
    xmlpath = r'D:/ultralytics-main/zhongyaodata/zhongyaodataset/data_batch3/label'       # 设置 XML 标注文件路径
    txtpath = r'D:/ultralytics-main/zhongyaodata/zhongyaodataset/data_batch3/label_yolo'  # 设置输出的 TXT 文件路径
