...
def prune(args):
    ...
    for i in range(args.iterative_steps):
        ...
        # validation_model = YOLO(args.model)  # 重新初始化模型
        # validation_model.model.load_state_dict(model.model.state_dict())  # 仅复制权重
        # validation_model.model.to(model.device)  # 确保设备一致
